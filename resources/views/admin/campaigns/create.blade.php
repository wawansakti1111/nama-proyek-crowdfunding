            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    <form action="{{ route('admin.campaigns.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="image" class="block text-sm font-medium text-gray-700">Gambar Kampanye (Opsional)</label>
                            <input type="file" name="image" id="image" class="mt-1 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50">
                        </div>
                        <div class="mb-4">
                            <label for="target_amount" class="block text-sm font-medium text-gray-700">Target Donasi (Rp)</label>
                            <input type="number" name="target_amount" id="target_amount" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('target_amount') }}" required min="1000">
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500">Simpan Kampanye</button>
                        </div>
                    </form>
                </div>
            </div>
